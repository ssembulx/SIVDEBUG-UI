 ...
 */
@Component({
  selector: 'cqi-opensightingageingdistribution',
  templateUrl: './opensightingageingdistribution.component.html',
  styleUrls: ['./opensightingageingdistribution.component.css']
})
export class OpensightingageingdistributionComponent implements OnInit, OnDestroy {
  ...
  getDSI(duration?: string, groupDomain?: string, SKUIDcombination?: string, platform?: string, exposure?: String) {
    ...
    let data = {
      ...
      "Platform": platform,
      "Exposure": exposure,
      "SkUID": SKUIDcombination,
    }
    this.dataSvc.getopensightingageingdistribution(data).subscribe(res => {
      if (res) {
        this.getDcrDetailsList = res.opensightingdetail;
  ...
  renderChar() {
    ...
    //chart.data = [{ "exposure": "< 1 week", "exposureCount": "5988", "exposure_percent": "13", "exposurepercentageline": "25" }, { "exposure": "1 week - 2 weeks", "exposureCount": "15463", "exposure_percent": "33", "exposurepercentageline": "40" }, { "exposure": "2 week - 3 weeks", "exposureCount": "23114", "exposure_percent": "50", "exposurepercentageline": "30" }, { "exposure": "3 weeks - 4 weeks", "exposureCount": "1050", "exposure_percent": "2", "exposurepercentageline": "5" }]
    //color list
    chart.colors.list = [
    ...
    columnSeries.name = "Critical & high HSDs by age";
    columnSeries.dataFields.valueY = "percentage";
    columnSeries.dataFields.categoryX = "charttype";
    columnSeries.dataFields.value = "sightingCount";
    ...
    var lineSeries = chart.series.push(new am4charts.LineSeries());
    lineSeries.name = "Desired distribution";
    lineSeries.dataFields.valueY = "constantLine";
    lineSeries.dataFields.categoryX = "charttype";
    lineSeries.stroke = am4core.color("#fdd400"); // yellow
    lineSeries.strokeWidth = 2;
    lineSeries.propertyFields.strokeDasharray = "lineDash";
