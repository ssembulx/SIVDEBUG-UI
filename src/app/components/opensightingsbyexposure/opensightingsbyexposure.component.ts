 ...
 */
@Component({
  selector: 'cqi-opensightingsbyexposure',
  templateUrl: './opensightingsbyexposure.component.html',
  styleUrls: ['./opensightingsbyexposure.component.css']
})
export class OpensightingsbyexposureComponent implements OnInit, OnDestroy {
  ...
  renderChar() {
    ...
    columnSeries.name = "Distribution of HSDs by exposure";
