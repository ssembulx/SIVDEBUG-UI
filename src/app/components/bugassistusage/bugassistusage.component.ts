 ...
 */
@Component({
  selector: 'cqi-bugassistusage',
  templateUrl: './bugassistusage.component.html',
  styleUrls: ['./bugassistusage.component.css']
})
export class BugassistusageComponent implements OnInit, OnDestroy {
  ...
  renderChar() {
    ...
    yAxis.min = 0;
    yAxis.title.text = '[bold] Count of HSDs';
    ...
    createSeries('hsdesDataCount', 'Overall HSDs submitted');
    createSeries('buggAssistDataCount', 'HSDs submitted via bugAssist');
    ...
    function createTraigeLineSeries() {
      ...
      yAxis.title.text = '[bold] bugAssist.newSighitng usage';
      yAxis.renderer.labels.template.fill = am4core.color("#000000");
      yAxis.renderer.labels.template.fontSize = 12;
      ...
      lineSeries.name = "bugAssist.newSighitng usage";
      lineSeries.dataFields.valueY = "bugAssistAdoption_Percent";
